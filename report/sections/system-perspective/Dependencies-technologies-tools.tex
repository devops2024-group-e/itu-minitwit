...
\begin{longtable}{|p{0.3\textwidth}|p{0.2\textwidth} | p{0.4\textwidth}|}
    ...
    \hline
    Dependency monitor & \href{https://docs.github.com/en/code-security/dependabot}{Dependabot} & Dependabot is a GitHub feature used for detecting outdated packages, dependencies and actions in repositories. We chose Dependabot as it would integrate well with our CI/CD pipeline in GitHub Actions.
    \hline
