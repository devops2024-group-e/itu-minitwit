...
In Table \ref{tab:tool} we briefly describe the tools and technologies used. A comprehensive list of tools and reasoning for their use can be found in appendix \ref{appendix:decision-log}.
