...
% \begin{Shaded}
%     \begin{Highlighting}[]
%         \ExtensionTok{$}\NormalTok{ scp }\AttributeTok{{-}r}\NormalTok{ student@164.90.160.52:/home/student/itu{-}minitwit \textasciitilde{}/Desktop/}
%     \end{Highlighting}
% \end{Shaded}
...
% \begin{Shaded}
%     \begin{Highlighting}[]
%         \ExtensionTok{$}\NormalTok{ scp student@164.90.160.52:/tmp/minitwit.db \textasciitilde{}/Desktop/itu{-}minitwit}
%     \end{Highlighting}
% \end{Shaded}
...
% \begin{Shaded}
%     \begin{Highlighting}[]
%         \ExtensionTok{$}\NormalTok{ git clone https://github.com/devops2024{-}group{-}e/itu{-}minitwit.git}
%     \end{Highlighting}
% \end{Shaded}
...
\begin{enumerate}
    ...
    % \begin{Shaded}
    %     \begin{Highlighting}[]
    %     \NormalTok{builder}\OperatorTok{.}\FunctionTok{Services}\OperatorTok{.}\FunctionTok{AddDistributedMemoryCache}\OperatorTok{();}

    %     \NormalTok{    builder}\OperatorTok{.}\FunctionTok{Services}\OperatorTok{.}\FunctionTok{AddSession}\OperatorTok{(}\NormalTok{options }\OperatorTok{=\textgreater{}}
    %         \OperatorTok{\{}
    %     \NormalTok{        options}\OperatorTok{.}\FunctionTok{IdleTimeout} \OperatorTok{=}\NormalTok{ TimeSpan}\OperatorTok{.}\FunctionTok{FromMinutes}\OperatorTok{(}\DecValTok{5}\OperatorTok{);}
    %     \NormalTok{        options}\OperatorTok{.}\FunctionTok{Cookie}\OperatorTok{.}\FunctionTok{HttpOnly} \OperatorTok{=} \KeywordTok{true}\OperatorTok{;}
    %     \NormalTok{        options}\OperatorTok{.}\FunctionTok{Cookie}\OperatorTok{.}\FunctionTok{IsEssential} \OperatorTok{=} \KeywordTok{true}\OperatorTok{;}
    %         \OperatorTok{\});}

    %         \OperatorTok{...}

    %     \NormalTok{    app}\OperatorTok{.}\FunctionTok{UseSession}\OperatorTok{();}
    %     \end{Highlighting}
    % \end{Shaded}
...
% \begin{Shaded}
%     \begin{Highlighting}[]
%         \NormalTok{services}\OperatorTok{.}\FunctionTok{AddRazorPagesOptions}\OperatorTok{(}\NormalTok{options }\OperatorTok{=\textgreater{}} \OperatorTok{\{}
%         \NormalTok{        options}\OperatorTok{.}\FunctionTok{Conventions}\OperatorTok{.}\FunctionTok{AddPageRoute}\OperatorTok{(}\StringTok{"\textless{}Ref to page\textgreater{}"}\OperatorTok{,} \StringTok{"new/route/to/page"}\OperatorTok{);}
%         \OperatorTok{\});}
%     \end{Highlighting}
% \end{Shaded}
...
\begin{enumerate}
    ...
    % \begin{Shaded}
    % \begin{Highlighting}[]
    % \CommentTok{// Register source of configurations}
    % \NormalTok{builder}\OperatorTok{.}\FunctionTok{Configuration}
        % \OperatorTok{.}\FunctionTok{AddJsonFile}\OperatorTok{(}\StringTok{"appsettings.json"}\OperatorTok{,}\NormalTok{ optional}\OperatorTok{:} \KeywordTok{false}\OperatorTok{,}\NormalTok{ reloadOnChange}\OperatorTok{:} \KeywordTok{true}\OperatorTok{)}
        % \OperatorTok{.}\FunctionTok{AddJsonFile}\OperatorTok{(}\NormalTok{$}\StringTok{"appsettings.\{builder.Environment.EnvironmentName\}.json"}\OperatorTok{,}\NormalTok{ optional}\OperatorTok{:} \KeywordTok{true}\OperatorTok{)}
        % \OperatorTok{.}\FunctionTok{AddEnvironmentVariables}\OperatorTok{(}\NormalTok{prefix}\OperatorTok{:} \StringTok{"Minitwit\_"}\OperatorTok{);}
    % \end{Highlighting}
    % \end{Shaded}
    ...
    % \begin{Shaded}
    % \begin{Highlighting}[]
    % \NormalTok{builder}\OperatorTok{.}\FunctionTok{Services}\OperatorTok{.}\FunctionTok{AddDbContext}\OperatorTok{\textless{}}\NormalTok{MinitwitContext}\OperatorTok{\textgreater{}(}\NormalTok{options }\OperatorTok{=\textgreater{}}
    % \OperatorTok{\{}
    % \NormalTok{    options}\OperatorTok{.}\FunctionTok{UseSqlite}\OperatorTok{(}\NormalTok{builder}\OperatorTok{.}\FunctionTok{Configuration}\OperatorTok{.}\FunctionTok{GetConnectionString}\OperatorTok{(}\StringTok{"MinitwitDatabase"}\OperatorTok{));}
    % \OperatorTok{\});}
    % \end{Highlighting}
    % \end{Shaded}
...
\begin{enumerate}
    ...
    % \begin{Shaded}
    % \begin{Highlighting}[]
    % \ExtensionTok{host}\NormalTok{ devops}
    %     \ExtensionTok{Hostname}\NormalTok{ 161.35.78.128}
    %     \ExtensionTok{User}\NormalTok{ root}
    %     \ExtensionTok{Identityfile}\NormalTok{ \textasciitilde{}/.ssh/do\_ssh\_key}
    % \end{Highlighting}
    % \end{Shaded}
...
\begin{enumerate}
    ...
    \begin{Shaded}
    \begin{Highlighting}[]
    \ExtensionTok{docker}\NormalTok{ build }\AttributeTok{{-}f}\NormalTok{ Dockerfile.backend . }\AttributeTok{{-}t}\NormalTok{ ghcr.io/devops2024{-}group{-}e/backend.minitwit:latest}
    \end{Highlighting}
    \end{Shaded}
    ...
    % \begin{Highlighting}[]
    % \ExtensionTok{docker}\NormalTok{ build }\AttributeTok{{-}f}\NormalTok{ Dockerfile.backend . }\AttributeTok{{-}t}\NormalTok{ ghcr.io/devops2024{-}group{-}e/backend.minitwit:latest}
    % \ExtensionTok{docker}\NormalTok{ build }\AttributeTok{{-}f}\NormalTok{ Dockerfile.frontend . }\AttributeTok{{-}t}\NormalTok{ ghcr.io/devops2024{-}group{-}e/frontend.minitwit:latest}
    % \ExtensionTok{docker}\NormalTok{ build }\AttributeTok{{-}f}\NormalTok{ Dockerfile.database . }\AttributeTok{{-}t}\NormalTok{ ghcr.io/devops2024{-}group{-}e/db.minitwit:latest}

    % \CommentTok{\# Authenticate to the github private container registry}
    % \ExtensionTok{docker}\NormalTok{ login ghcr.io }\AttributeTok{{-}u} \OperatorTok{\textless{}}\NormalTok{github username}\OperatorTok{\textgreater{}}\NormalTok{ {-}p }\OperatorTok{\textless{}}\NormalTok{github token}\OperatorTok{\textgreater{}}

    % \CommentTok{\# Push the build images to the container registry}
    % \ExtensionTok{docker}\NormalTok{ push ghcr.io/devops2024{-}group{-}e/backend.minitwit:latest}
    % \ExtensionTok{docker}\NormalTok{ push ghcr.io/devops2024{-}group{-}e/frontend.minitwit:latest}
    % \ExtensionTok{docker}\NormalTok{ push ghcr.io/devops2024{-}group{-}e/db.minitwit:latest}
    % \end{Highlighting}
    % \end{Shaded}
    ...
    % \begin{Shaded}
    % \begin{Highlighting}[]
    % \ExtensionTok{docker}\NormalTok{ run }\AttributeTok{{-}p}\NormalTok{ 5432:5432 }\AttributeTok{{-}{-}name}\NormalTok{ database }\AttributeTok{{-}d}\NormalTok{ ghcr.io/devops2024{-}group{-}e/db.minitwit:latest}
    % \ExtensionTok{docker}\NormalTok{ run }\AttributeTok{{-}p}\NormalTok{ 80:80 }\AttributeTok{{-}{-}name}\NormalTok{ frontend }\AttributeTok{{-}d}\NormalTok{ ghcr.io/devops2024{-}group{-}e/frontend.minitwit:latest}
    % \ExtensionTok{docker}\NormalTok{ run }\AttributeTok{{-}p}\NormalTok{ 8080:8080 }\AttributeTok{{-}{-}name}\NormalTok{ backend }\AttributeTok{{-}d}\NormalTok{ ghcr.io/devops2024{-}group{-}e/backend.minitwit:latest}
    % \end{Highlighting}
    % \end{Shaded}
    ...
    % \begin{Shaded}
    % \begin{Highlighting}[]
    % \BuiltInTok{echo} \VariableTok{$DOCKER\_PASSWORD} \KeywordTok{|} \ExtensionTok{docker}\NormalTok{ login ghcr.io }\AttributeTok{{-}u} \VariableTok{$DOCKER\_USERNAME} \AttributeTok{{-}{-}password{-}stdin}
    % \ExtensionTok{docker}\NormalTok{ run }\AttributeTok{{-}{-}platform}\NormalTok{ linux/amd64 }\AttributeTok{{-}p}\NormalTok{ 80:80 }\AttributeTok{{-}d}\NormalTok{ ghcr.io/devops2024{-}group{-}e/frontend.minitwit}
    % \ExtensionTok{docker}\NormalTok{ run }\AttributeTok{{-}{-}platform}\NormalTok{ linux/amd64 }\AttributeTok{{-}p}\NormalTok{ 8080:8080 }\AttributeTok{{-}d}\NormalTok{ ghcr.io/devops2024{-}group{-}e/backend.minitwit}
    % \end{Highlighting}
    % \end{Shaded}
...
We started by creating a ``skeleton'' workflow that would only run when
...
% \begin{Shaded}
% \begin{Highlighting}[]
% \ExtensionTok{Error:}\NormalTok{ Cannot perform an interactive login from a non TTY device}
% \ExtensionTok{no}\NormalTok{ configuration file provided: not found}
% \ExtensionTok{no}\NormalTok{ configuration file provided: not found}
% \ExtensionTok{no}\NormalTok{ configuration file provided: not found}
% \end{Highlighting}
% \end{Shaded}
...
\begin{enumerate}
    ...
    % \begin{Shaded}
    % \begin{Highlighting}[]
    % \KeywordTok{CREATE} \KeywordTok{ROLE}\NormalTok{ minitwit\_app\_executer;}
    % \KeywordTok{GRANT} \KeywordTok{SELECT}\NormalTok{, }\KeywordTok{UPDATE}\NormalTok{, }\KeywordTok{INSERT}\NormalTok{, }\KeywordTok{DELETE} \KeywordTok{ON} \KeywordTok{ALL} \KeywordTok{TABLES} \KeywordTok{IN} \KeywordTok{SCHEMA} \KeywordTok{public} \KeywordTok{TO}\NormalTok{ minitwit\_app\_executer;}
    % \end{Highlighting}
    % \end{Shaded}
    \item We(or I, Andreas) got tired and decided to not perform the migration until we have more time\ldots{}
\end{enumerate}

\section{Add monitoring:}
...
% \begin{Shaded}
% \begin{Highlighting}[]
% \ExtensionTok{dotnet}\NormalTok{ add package OpenTelemetry.Exporter.Prometheus.AspNetCore }\AttributeTok{{-}{-}version}\NormalTok{ 1.4.0{-}rc.4}
% \ExtensionTok{dotnet}\NormalTok{ add package OpenTelemetry.Extensions.Hosting}

% \ExtensionTok{dotnet}\NormalTok{ add package OpenTelemetry.Instrumentation.AspNetCore}
% \end{Highlighting}
% \end{Shaded}
...
% \begin{Shaded}
% \begin{Highlighting}[]
% \FunctionTok{builder.Services.AddOpenTelemetry()}
%   \ExtensionTok{.WithMetrics}\ErrorTok{(}\ExtensionTok{b}\NormalTok{ =}\OperatorTok{\textgreater{}}\NormalTok{ b.AddPrometheusExporter}\ErrorTok{(}\KeywordTok{));}

% \FunctionTok{app.UseOpenTelemetryPrometheusScrapingEndpoint()}\KeywordTok{;}
% \end{Highlighting}
% \end{Shaded}
...
% \begin{Shaded}
% \begin{Highlighting}[]
% \OperatorTok{\textless{}}\NormalTok{PackageReference Include}\OperatorTok{=}\StringTok{"OpenTelemetry.Exporter.Prometheus.AspNetCore"}\NormalTok{ Version}\OperatorTok{=}\StringTok{"1.7.0{-}rc.1"} \OperatorTok{/\textgreater{}}
% \OperatorTok{\textless{}}\NormalTok{PackageReference Include}\OperatorTok{=}\StringTok{"OpenTelemetry.Extensions.Hosting"}\NormalTok{ Version}\OperatorTok{=}\StringTok{"1.7.0"} \OperatorTok{/\textgreater{}}
% \OperatorTok{\textless{}}\NormalTok{PackageReference Include}\OperatorTok{=}\StringTok{"OpenTelemetry.Instrumentation.AspNetCore"}\NormalTok{ Version}\OperatorTok{=}\StringTok{"1.7.1"} \OperatorTok{/\textgreater{}}
% \end{Highlighting}
% \end{Shaded}
...
% \begin{Shaded}
% \begin{Highlighting}[]
% \NormalTok{builder}\OperatorTok{.}\FunctionTok{Services}\OperatorTok{.}\FunctionTok{AddOpenTelemetry}\OperatorTok{()}
%   \OperatorTok{.}\FunctionTok{WithMetrics}\OperatorTok{(}\NormalTok{b }\OperatorTok{=\textgreater{}}\NormalTok{ b}\OperatorTok{.}\FunctionTok{AddAspNetCoreInstrumentation}\OperatorTok{()}
%                      \OperatorTok{.}\FunctionTok{AddPrometheusExporter}\OperatorTok{());}

% \NormalTok{app}\OperatorTok{.}\FunctionTok{UseOpenTelemetryPrometheusScrapingEndpoint}\OperatorTok{();}
% \end{Highlighting}
% \end{Shaded}
...
% \begin{Shaded}
% \begin{Highlighting}[]
% \NormalTok{\_logger}\OperatorTok{.}\FunctionTok{LogDebug}\OperatorTok{(}\NormalTok{$}\StringTok{"FollowUnfollowUser returns Forbid because user is not logged in"}\OperatorTok{);}
% \end{Highlighting}
% \end{Shaded}
...
% \begin{Shaded}
% \begin{Highlighting}[]
% \BuiltInTok{export} \VariableTok{CONF\_DO\_TOKEN}\OperatorTok{=}\NormalTok{dop\_v1\_0221256529632baf8d30514aff483ab4ca0caa263c2a0f63f93a07da4ef6c7e4}
% \end{Highlighting}
% \end{Shaded}
...
\item Create a new test repo for testing provisioning of VMs using github workflows
    ...
    % \begin{Shaded}
    % \begin{Highlighting}[]
    % \ExtensionTok{docker}\NormalTok{ build }\AttributeTok{{-}t}\NormalTok{ ansible:latest .}
    % \ExtensionTok{docker}\NormalTok{ run }\AttributeTok{{-}it} \AttributeTok{{-}{-}rm}\NormalTok{ ansible:latest bash}
    % \end{Highlighting}
    % \end{Shaded}
    ...
    % \begin{Shaded}
    % \begin{Highlighting}[]
    % \KeywordTok{{-}}\AttributeTok{ }\FunctionTok{name}\KeywordTok{:}\AttributeTok{ Provision and deploy web servers}
    % \AttributeTok{  }\FunctionTok{uses}\KeywordTok{:}\AttributeTok{ .github/actions/ansible{-}run{-}playbook}
    % \end{Highlighting}
    % \end{Shaded}
    ...
    \begin{Shaded}
    \begin{Highlighting}[]
    \FunctionTok{inputs}\KeywordTok{:}
    \AttributeTok{  }\FunctionTok{dotoken}\KeywordTok{:}
    \AttributeTok{    }\FunctionTok{description}\KeywordTok{:}\AttributeTok{ }\StringTok{\textquotesingle{}The Digital Ocean token\textquotesingle{}}
    \AttributeTok{    }\FunctionTok{required}\KeywordTok{:}\AttributeTok{ }\CharTok{true}
    \AttributeTok{  }\FunctionTok{dosshkeyname}\KeywordTok{:}
    \AttributeTok{    }\FunctionTok{description}\KeywordTok{:}\AttributeTok{ }\StringTok{\textquotesingle{}The name of the ssh key in Digital Ocean\textquotesingle{}}
    \AttributeTok{    }\FunctionTok{required}\KeywordTok{:}\AttributeTok{ }\CharTok{true}
    \AttributeTok{  }\FunctionTok{sshkey}\KeywordTok{:}
    \AttributeTok{    }\FunctionTok{description}\KeywordTok{:}\AttributeTok{ }\StringTok{\textquotesingle{}The private ssh key to access servers\textquotesingle{}}
    \AttributeTok{    }\FunctionTok{required}\KeywordTok{:}\AttributeTok{ }\CharTok{true}
    \AttributeTok{  }\FunctionTok{dockeruser}\KeywordTok{:}
    \AttributeTok{    }\FunctionTok{description}\KeywordTok{:}\AttributeTok{ }\StringTok{\textquotesingle{}The username for the docker registry\textquotesingle{}}
    \AttributeTok{    }\FunctionTok{required}\KeywordTok{:}\AttributeTok{ }\CharTok{true}
    \AttributeTok{  }\FunctionTok{dockerpassword}\KeywordTok{:}
    \AttributeTok{    }\FunctionTok{description}\KeywordTok{:}\AttributeTok{ }\StringTok{\textquotesingle{}The password for the docker registry\textquotesingle{}}
    \AttributeTok{    }\FunctionTok{required}\KeywordTok{:}\AttributeTok{ }\CharTok{true}
    \AttributeTok{  }\FunctionTok{inventoryfile}\KeywordTok{:}
    \AttributeTok{    }\FunctionTok{description}\KeywordTok{:}\AttributeTok{ }\StringTok{\textquotesingle{}The working directory to run the command in\textquotesingle{}}
    \AttributeTok{    }\FunctionTok{required}\KeywordTok{:}\AttributeTok{ }\CharTok{true}
    \AttributeTok{  }\FunctionTok{playbook}\KeywordTok{:}
    \AttributeTok{    }\FunctionTok{description}\KeywordTok{:}\AttributeTok{ }\StringTok{\textquotesingle{}The playbook to run\textquotesingle{}}
    \AttributeTok{    }\FunctionTok{required}\KeywordTok{:}\AttributeTok{ }\CharTok{true}
    \AttributeTok{  }\FunctionTok{working{-}directory}\KeywordTok{:}
    \AttributeTok{    }\FunctionTok{description}\KeywordTok{:}\AttributeTok{ }\StringTok{\textquotesingle{}The working directory to run the command in\textquotesingle{}}
    \AttributeTok{    }\FunctionTok{required}\KeywordTok{:}\AttributeTok{ }\CharTok{true}
    \FunctionTok{runs}\KeywordTok{:}
    \AttributeTok{  }\FunctionTok{using}\KeywordTok{:}\AttributeTok{ }\StringTok{\textquotesingle{}docker\textquotesingle{}}
    \AttributeTok{  }\FunctionTok{image}\KeywordTok{:}\AttributeTok{ }\StringTok{\textquotesingle{}Dockerfile\textquotesingle{}}
    \AttributeTok{  }\FunctionTok{args}\KeywordTok{:}
    \AttributeTok{    }\KeywordTok{{-}}\AttributeTok{ $\{\{ inputs.sshkey\}\}}
    \AttributeTok{    }\KeywordTok{{-}}\AttributeTok{ $\{\{ inputs.dockeruser \}\}}
    \AttributeTok{    }\KeywordTok{{-}}\AttributeTok{ $\{\{ inputs.dockerpassword \}\}}
    \AttributeTok{    }\KeywordTok{{-}}\AttributeTok{ $\{\{ inputs.dotoken \}\}}
    \AttributeTok{    }\KeywordTok{{-}}\AttributeTok{ $\{\{ inputs.dosshkeyname \}\}}
    \AttributeTok{    }\KeywordTok{{-}}\AttributeTok{ $\{\{ inputs.inventoryfile \}\}}
    \AttributeTok{    }\KeywordTok{{-}}\AttributeTok{ $\{\{ inputs.playbook \}\}}
    \AttributeTok{    }\KeywordTok{{-}}\AttributeTok{ $\{\{ inputs.working{-}directory \}\}}
    \end{Highlighting}
    \end{Shaded}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            % \begin{Shaded}
            % \begin{Highlighting}[]
            % \FunctionTok{collections}\KeywordTok{:}
            % \AttributeTok{    community.docker:\textless{}version\textgreater{}}
            % \end{Highlighting}
            % \end{Shaded}
    ...
    \begin{itemize}
        ...
        % \begin{Shaded}
        % \begin{Highlighting}[]
        % \AttributeTok{ }\KeywordTok{{-}}\AttributeTok{ }\FunctionTok{name}\KeywordTok{:}\AttributeTok{ Login to GitHub Container Registry}
        ...
        % \AttributeTok{          }\FunctionTok{username}\KeywordTok{:}\AttributeTok{ $\{\{ secrets.DOCKER\_USER \}\}}
        % \AttributeTok{          }\FunctionTok{password}\KeywordTok{:}\AttributeTok{ $\{\{ secrets.DOCKER\_PWD \}\}}
        ...
        % \AttributeTok{        }\FunctionTok{with}\KeywordTok{:}
        % \AttributeTok{          }\FunctionTok{path}\KeywordTok{:}\AttributeTok{ main}

        % \AttributeTok{      }\KeywordTok{{-}}\AttributeTok{ }\FunctionTok{name}\KeywordTok{:}\AttributeTok{ Fetch Ansible Playbook action}
        % \AttributeTok{        }\FunctionTok{uses}\KeywordTok{:}\AttributeTok{ actions/checkout@v4}
        % \AttributeTok{        }\FunctionTok{with}\KeywordTok{:}
        % \AttributeTok{          }\FunctionTok{repository}\KeywordTok{:}\AttributeTok{ devops2024{-}group{-}e/ansible{-}action}
        % \FunctionTok{          sparse{-}checkout}\KeywordTok{: }\CharTok{|}
        % \NormalTok{            .github/actions/ansible{-}run{-}playbook}
        % \AttributeTok{          }\FunctionTok{sparse{-}checkout{-}cone{-}mode}\KeywordTok{:}\AttributeTok{ }\CharTok{false}
        % \AttributeTok{          }\FunctionTok{path}\KeywordTok{:}\AttributeTok{ action}

        % \AttributeTok{      }\KeywordTok{{-}}\AttributeTok{ }\FunctionTok{name}\KeywordTok{:}\AttributeTok{ Provision and deploy web servers}
        % \AttributeTok{        }\FunctionTok{uses}\KeywordTok{:}\AttributeTok{ ./action/.github/actions/ansible{-}run{-}playbook}
        % \AttributeTok{        }\FunctionTok{with}\KeywordTok{:}
        % \AttributeTok{          }\FunctionTok{dotoken}\KeywordTok{:}\AttributeTok{ $\{\{ secrets.DIGITAL\_OCEAN\_TOKEN \}\}}
        % \AttributeTok{          }\FunctionTok{dosshkeyname}\KeywordTok{:}\AttributeTok{ $\{\{ secrets.DIGITAL\_OCEAN\_ANSIBLE\_SSH\_KEY\_NAME \}\}}
        % \AttributeTok{          }\FunctionTok{sshkey}\KeywordTok{:}\AttributeTok{ $\{\{ secrets.ANSIBLE\_SSH\_KEY \}\}}
        % \AttributeTok{          }\FunctionTok{dockeruser}\KeywordTok{:}\AttributeTok{ $\{\{ secrets.DOCKER\_USER \}\}}
        % \AttributeTok{          }\FunctionTok{dockerpassword}\KeywordTok{:}\AttributeTok{ $\{\{ secrets.DOCKER\_PWD \}\}}
        % \AttributeTok{          }\FunctionTok{inventoryfile}\KeywordTok{:}\AttributeTok{ inventory.ansible}
        % \AttributeTok{          }\FunctionTok{playbook}\KeywordTok{:}\AttributeTok{ web{-}playbook.yaml}
        % \AttributeTok{          }\FunctionTok{working{-}directory}\KeywordTok{:}\AttributeTok{ main/.infrastructure}
        % \end{Highlighting}
        % \end{Shaded}
    \end{itemize}
\end{itemize}
...
% \begin{Shaded}
% \begin{Highlighting}[]
% \NormalTok{brew install pre}\OperatorTok{{-}}\NormalTok{commit}

% \NormalTok{pre}\OperatorTok{{-}}\NormalTok{commit sample}\OperatorTok{{-}}\NormalTok{config }\OperatorTok{\textgreater{}} \OperatorTok{.}\FunctionTok{pre}\OperatorTok{{-}}\NormalTok{commit}\OperatorTok{{-}}\NormalTok{config}\OperatorTok{.}\FunctionTok{yaml}

% \NormalTok{dotnet tool install }\OperatorTok{{-}}\NormalTok{g dotnet}\OperatorTok{{-}}\NormalTok{format }\OperatorTok{{-}{-}}\NormalTok{version }\StringTok{"7.*"} \OperatorTok{{-}{-}}\NormalTok{add}\OperatorTok{{-}}\NormalTok{source https}\OperatorTok{:}\CommentTok{//pkgs.dev.azure.com/dnceng/public/\_packaging/dotnet7/nuget/v3/index.json}
% \end{Highlighting}
% \end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\ExtensionTok{pg\_dump} \AttributeTok{{-}U}\NormalTok{ minitwit\_sa }\AttributeTok{{-}f}\NormalTok{ dump.sql }\AttributeTok{{-}{-}column{-}inserts} \AttributeTok{{-}{-}data{-}only}\NormalTok{ minitwit}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\ExtensionTok{docker}\NormalTok{ exec }\AttributeTok{{-}it}\NormalTok{ database /bin/sh }\AttributeTok{{-}c} \StringTok{"cat dump.sql"} \OperatorTok{\textgreater{}}\NormalTok{ dump.sql}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{scp}\NormalTok{ devops:/minitwit/dump.sql ./dump.sql}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OtherTok{.PHONY:}\DataTypeTok{ db{-}down}
\DecValTok{db{-}down:}
\NormalTok{    docker exec {-}it minitwit{-}dev{-}database /bin/sh {-}c }\StringTok{"psql {-}U minitwit{-}sa minitwit {-}c \textquotesingle{}TRUNCATE TABLE follower, \textbackslash{}"}\NormalTok{user\textbackslash{}}\StringTok{", message, latest\textquotesingle{}"}

\OtherTok{.PHONY:}\DataTypeTok{ db{-}up}
\DecValTok{db{-}up:}
\NormalTok{    docker cp ./dump.sql minitwit{-}dev{-}database:/db{-}setup/dump.sql}
\NormalTok{    docker exec {-}it minitwit{-}dev{-}database /bin/sh {-}c }\StringTok{"psql {-}U minitwit{-}sa minitwit \textless{} /db{-}setup/dump.sql"}\NormalTok{ \textgreater{} /dev/null}

\OtherTok{.PHONY:}\DataTypeTok{ db{-}refresh}
\DecValTok{db{-}refresh:}\DataTypeTok{ db{-}down db{-}up}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ALTER TABLE message}
\NormalTok{    ALTER COLUMN pub\_date TYPE bigint;}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}
\centering
\includegraphics{Log 8f540289b13a4fffb76a9996bb03c9a8/Untitled.png}
\caption{Untitled}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{Log 8f540289b13a4fffb76a9996bb03c9a8/Untitled 1.png}
\caption{Untitled}
\end{figure}
...
\begin{itemize}
    ...
    \FunctionTok{wget}\NormalTok{ https://dot.net/v1/dotnet{-}install.sh }\AttributeTok{{-}O}\NormalTok{ dotnet{-}install.sh}
    \FunctionTok{chmod}\NormalTok{ +x ./dotnet{-}install.sh}
    \ExtensionTok{./dotnet{-}install.sh} \AttributeTok{{-}{-}version}\NormalTok{ latest }\AttributeTok{{-}{-}install{-}dir} \StringTok{"/usr/share/dotnet{-}new"}

    \FunctionTok{sudo}\NormalTok{ cp }\AttributeTok{{-}u} \AttributeTok{{-}r}\NormalTok{ /usr/share/dotnet{-}new/}\PreprocessorTok{*}\NormalTok{ /usr/share/dotnet/}
    \end{Highlighting}
    \end{Shaded}
    ...
    % \begin{Shaded}
    % \begin{Highlighting}[]
    % \FunctionTok{wget} \AttributeTok{{-}q} \AttributeTok{{-}O}\NormalTok{ /bin/hadolint }\StringTok{"https://github.com/hadolint/hadolint/releases/download/v2.10.0/hadolint{-}Linux{-}}\VariableTok{$(}\ExtensionTok{dpkg} \AttributeTok{{-}{-}print{-}architecture}\VariableTok{)}\StringTok{"}
    % \end{Highlighting}
    % \end{Shaded}
    \item I didn't have the permission to use hadolint, so i gave the permission in the image with the following command:
    \begin{Shaded}
    \begin{Highlighting}[]
    \FunctionTok{chmod}\NormalTok{ +x /bin/hadolint}
    \end{Highlighting}
    \end{Shaded}
    \end{itemize}
...
\begin{Shaded}
\begin{Highlighting}[]
\ExtensionTok{$}\NormalTok{ apt install docker.io}
\CommentTok{\# the ip address here is the private ip for the manager server. (found on digital ocean)}
\ExtensionTok{$}\NormalTok{ docker swarm init }\AttributeTok{{-}{-}advertise{-}addr}\NormalTok{  192.168.1.6 }
\ExtensionTok{Swarm}\NormalTok{ initialized: current node }\ErrorTok{(}\ExtensionTok{qvekvmy3xdpftrheics2kt05v}\KeywordTok{)} \ExtensionTok{is}\NormalTok{ now a manager.}

\ExtensionTok{To}\NormalTok{ add a worker to this swarm, run the following command:}

    \ExtensionTok{docker}\NormalTok{ swarm join }\AttributeTok{{-}{-}token}\NormalTok{ SWMTKN{-}1{-}5bsq5avkideo5oqx6n4b5oth1nhqyg96msjp2igiome125afai{-}8xk1y3dmymf75zgcia1yrpj2c 192.168.1.6:2377}

\ExtensionTok{To}\NormalTok{ add a manager to this swarm, run }\StringTok{\textquotesingle{}docker swarm join{-}token manager\textquotesingle{}}\NormalTok{ and follow the instructions.}
\end{Highlighting}
\end{Shaded}
...
\subsection{Migrating Database}\label{migrating-database}}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{scp}\NormalTok{ dump.sql devops{-}test:/minitwit/dump.sql}
\FunctionTok{ssh}\NormalTok{ devops{-}test}

\ExtensionTok{docker}\NormalTok{ cp /minitwit/dump.sql database:/db{-}setup/dump.sql}

\ExtensionTok{docker}\NormalTok{ exec database /bin/bash }\AttributeTok{{-}c} \StringTok{"psql {-}U minitwit{-}sa minitwit \textless{} /db{-}setup/dump.sql"}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# First we need to run pg\_dump for the old database server and save the dump file}
\BuiltInTok{echo} \StringTok{"Fetch Database dump from source database"}
\ExtensionTok{pg\_dump} \AttributeTok{{-}h}\NormalTok{ 164.92.253.253 }\AttributeTok{{-}U}\NormalTok{ minitwit{-}sa }\AttributeTok{{-}p}\NormalTok{ 5432 }\AttributeTok{{-}Fc}\NormalTok{ minitwit }\OperatorTok{\textgreater{}}\NormalTok{ ./minitwit{-}dump.pgsql}

\CommentTok{\# Secondly we need to run pg\_restore on the new database with the dump file that we have just saved}
\BuiltInTok{echo} \StringTok{"Restoring database on target database"}
\ExtensionTok{pg\_restore} \AttributeTok{{-}d} \OperatorTok{\textless{}}\NormalTok{Connection uri string from DO}\OperatorTok{\textgreater{}}\NormalTok{ {-}{-}jobs 4 ./minitwit{-}dump.pgsql}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\FunctionTok{ssh}\NormalTok{ devops{-}test}
\ExtensionTok{ufw}\NormalTok{ allow in on eth0 to any port 5432}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\ExtensionTok{164.92.253.253:5432:minitwit:minitwit{-}sa:}\OperatorTok{\textless{}}\NormalTok{Password of the db user}\OperatorTok{\textgreater{}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\ExtensionTok{pg\_restore:}\NormalTok{ error: could not execute query: ERROR:  relation }\StringTok{"follower"}\NormalTok{ already exists}
\ExtensionTok{Command}\NormalTok{ was: CREATE TABLE public.follower }\ErrorTok{(}
    \ExtensionTok{who\_id}\NormalTok{ integer NOT NULL,}
    \ExtensionTok{whom\_id}\NormalTok{ integer NOT NULL}
\KeywordTok{);}

\ExtensionTok{pg\_restore:}\NormalTok{ error: could not execute query: ERROR:  permission denied for schema public}
\ExtensionTok{Command}\NormalTok{ was: ALTER TABLE public.follower OWNER TO }\StringTok{"minitwit{-}sa"}\KeywordTok{;}

\ExtensionTok{pg\_restore:}\NormalTok{ error: could not execute query: ERROR:  relation }\StringTok{"latest"}\NormalTok{ already exists}
\ExtensionTok{Command}\NormalTok{ was: CREATE TABLE public.latest }\ErrorTok{(}
    \FunctionTok{id}\NormalTok{ integer NOT NULL,}
    \ExtensionTok{command\_id}\NormalTok{ integer NOT NULL}
\KeywordTok{);}
\ExtensionTok{...}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\ExtensionTok{pg\_restore:}\NormalTok{ error: a worker process died unexpectedly}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{GRANT} \KeywordTok{SELECT}\NormalTok{, }\KeywordTok{UPDATE}\NormalTok{, }\KeywordTok{INSERT}\NormalTok{, }\KeywordTok{DELETE} \KeywordTok{ON} \KeywordTok{ALL} \KeywordTok{TABLES} \KeywordTok{IN} \KeywordTok{SCHEMA} \KeywordTok{public} \KeywordTok{TO} \OtherTok{"minitwit{-}sa"}\NormalTok{;}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{GRANT} \KeywordTok{USAGE}\NormalTok{, }\KeywordTok{SELECT} \KeywordTok{ON} \KeywordTok{ALL}\NormalTok{ SEQUENCES }\KeywordTok{IN} \KeywordTok{SCHEMA} \KeywordTok{public} \KeywordTok{TO} \OtherTok{"minitwit{-}sa"}\NormalTok{;}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{\#!}\OperatorTok{/}\NormalTok{bin}\OperatorTok{/}\NormalTok{bash}

\NormalTok{ssh devops }\OtherTok{"/bin/bash {-}c \textquotesingle{}ufw allow in on eth0 to any port 5432\textquotesingle{}"}

\NormalTok{\# }\FunctionTok{First}\NormalTok{ we need }\KeywordTok{to}\NormalTok{ run pg\_dump }\ControlFlowTok{for} \KeywordTok{the} \KeywordTok{old} \KeywordTok{database}\NormalTok{ server }\KeywordTok{and}\NormalTok{ save }\KeywordTok{the} \FunctionTok{dump} \KeywordTok{file}
\NormalTok{echo }\OtherTok{"Fetch Database dump from source database"}
\NormalTok{pg\_dump }\OperatorTok{{-}}\NormalTok{h }\OperatorTok{\textless{}}\NormalTok{web server ip}\OperatorTok{\textgreater{}} \OperatorTok{{-}}\NormalTok{U minitwit}\OperatorTok{{-}}\NormalTok{sa }\OperatorTok{{-}}\NormalTok{p }\DecValTok{5432} \OperatorTok{{-}}\NormalTok{Fc minitwit }\OperatorTok{\textgreater{}}\NormalTok{ .}\OperatorTok{/}\NormalTok{minitwit}\OperatorTok{{-}}\FunctionTok{dump}\NormalTok{.pgsql}

\NormalTok{\# Secondly we need }\KeywordTok{to}\NormalTok{ run pg\_restore }\KeywordTok{on} \KeywordTok{the} \KeywordTok{new} \KeywordTok{database} \KeywordTok{with} \KeywordTok{the} \FunctionTok{dump} \KeywordTok{file}\NormalTok{ that we have just saved}
\NormalTok{echo }\OtherTok{"Restoring database on target database"}
\NormalTok{pg\_restore }\OperatorTok{{-}}\NormalTok{d }\OperatorTok{\textless{}}\NormalTok{DO URI connectionstring}\OperatorTok{\textgreater{}} \CommentTok{{-}{-}no{-}owner ./minitwit{-}dump.pgsql \# look like postgresql://doadmin:AVNS\_rJEiEqnQXPwDK4\_N\_mb@minitwit{-}test{-}db{-}01{-}7035523{-}do{-}user{-}15869692{-}0.c.db.ondigitalocean.com:25060/minitwit?sslmode=require}

\NormalTok{psql }\OperatorTok{{-}}\NormalTok{h minitwit}\OperatorTok{{-}}\NormalTok{test}\OperatorTok{{-}}\NormalTok{db}\OperatorTok{{-}}\DecValTok{01}\OperatorTok{{-}}\DecValTok{7035523}\OperatorTok{{-}}\NormalTok{do}\OperatorTok{{-}}\FunctionTok{user}\OperatorTok{{-}}\DecValTok{15869692}\OperatorTok{{-}}\FloatTok{0.}\NormalTok{c.db.ondigitalocean.com }\OperatorTok{{-}}\NormalTok{p }\DecValTok{25060} \OperatorTok{{-}}\NormalTok{U doadmin }\OperatorTok{{-}}\NormalTok{d minitwit }\OperatorTok{{-}}\NormalTok{c }\StringTok{\textquotesingle{}GRANT SELECT, UPDATE, INSERT, DELETE ON ALL TABLES IN SCHEMA public TO "minitwit{-}sa";\textquotesingle{}}
\NormalTok{psql }\OperatorTok{{-}}\NormalTok{h minitwit}\OperatorTok{{-}}\NormalTok{test}\OperatorTok{{-}}\NormalTok{db}\OperatorTok{{-}}\DecValTok{01}\OperatorTok{{-}}\DecValTok{7035523}\OperatorTok{{-}}\NormalTok{do}\OperatorTok{{-}}\FunctionTok{user}\OperatorTok{{-}}\DecValTok{15869692}\OperatorTok{{-}}\FloatTok{0.}\NormalTok{c.db.ondigitalocean.com }\OperatorTok{{-}}\NormalTok{p }\DecValTok{25060} \OperatorTok{{-}}\NormalTok{U doadmin }\OperatorTok{{-}}\NormalTok{d minitwit }\OperatorTok{{-}}\NormalTok{c }\StringTok{\textquotesingle{}GRANT USAGE, SELECT ON ALL SEQUENCES IN SCHEMA public TO "minitwit{-}sa";\textquotesingle{}}

\NormalTok{ssh devops }\OtherTok{"/bin/bash {-}c \textquotesingle{}ufw deny in on eth0 to any port 5432\textquotesingle{}"}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{mkdir} \AttributeTok{{-}p}\NormalTok{ data\_sources }\KeywordTok{\&\&} \ExtensionTok{curl} \AttributeTok{{-}s} \StringTok{"http://\textless{}ip of monitoring server\textgreater{}/api/datasources"}  \AttributeTok{{-}u}\NormalTok{ admin:admin}\KeywordTok{|}\ExtensionTok{jq} \AttributeTok{{-}c} \AttributeTok{{-}M} \StringTok{\textquotesingle{}.[]\textquotesingle{}}\KeywordTok{|}\FunctionTok{split} \AttributeTok{{-}l}\NormalTok{ 1 }\AttributeTok{{-}}\NormalTok{ data\_sources/}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{scp} \AttributeTok{{-}r}\NormalTok{ devops{-}test{-}mon:/minitwit{-}monitoring/grafana .infrastructure/monitor{-}server/grafana}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{public} \KeywordTok{static} \DataTypeTok{string} \FunctionTok{Hash}\OperatorTok{(}\DataTypeTok{string}\NormalTok{ value}\OperatorTok{)}
    \OperatorTok{\{}
        \DataTypeTok{var}\NormalTok{ salt }\OperatorTok{=}\NormalTok{ RandomNumberGenerator}\OperatorTok{.}\FunctionTok{GetBytes}\OperatorTok{(}\DecValTok{16}\OperatorTok{);}
        \KeywordTok{return} \FunctionTok{GeneratePasswordHash}\OperatorTok{(}\NormalTok{value}\OperatorTok{,}\NormalTok{ salt}\OperatorTok{,} \StringTok{"SHA512"}\OperatorTok{);}
    \OperatorTok{\}}
\end{Highlighting}
\end{Shaded}
...
% \begin{Shaded}
% \begin{Highlighting}[]
% \KeywordTok{private} \KeywordTok{static} \DataTypeTok{string} \FunctionTok{GeneratePasswordHash}\OperatorTok{(}\DataTypeTok{string}\NormalTok{ password}\OperatorTok{,} \DataTypeTok{byte}\OperatorTok{[]}\NormalTok{ salt}\OperatorTok{,} \DataTypeTok{string}\NormalTok{ algorithm}\OperatorTok{)}
%     \OperatorTok{\{}
%         \DataTypeTok{string}\NormalTok{ hashedResult}\OperatorTok{;}
%         \DataTypeTok{string}\NormalTok{ result}\OperatorTok{;}
%         \KeywordTok{switch} \OperatorTok{(}\NormalTok{algorithm}\OperatorTok{)}
%         \OperatorTok{\{}
%             \KeywordTok{case} \StringTok{"SHA512"}\OperatorTok{:}
% \NormalTok{                hashedResult }\OperatorTok{=}\NormalTok{ Convert}\OperatorTok{.}\FunctionTok{ToHexString}\OperatorTok{(}\NormalTok{KeyDerivation}\OperatorTok{.}\FunctionTok{Pbkdf2}\OperatorTok{(}
% \NormalTok{                    password}\OperatorTok{:}\NormalTok{ password}\OperatorTok{,}
% \NormalTok{                    salt}\OperatorTok{:}\NormalTok{ salt}\OperatorTok{,}
% \NormalTok{                    prf}\OperatorTok{:}\NormalTok{ KeyDerivationPrf}\OperatorTok{.}\FunctionTok{HMACSHA512}\OperatorTok{,}
% \NormalTok{                    iterationCount}\OperatorTok{:} \DecValTok{21000}\OperatorTok{,}
% \NormalTok{                    numBytesRequested}\OperatorTok{:} \DecValTok{32}\OperatorTok{));}
% \NormalTok{                result }\OperatorTok{=}\NormalTok{ $}\StringTok{"SHA512$\{Convert.ToHexString(salt)\}$\{hashedResult\}"}\OperatorTok{;}
%                 \KeywordTok{break}\OperatorTok{;}
%             \KeywordTok{default}\OperatorTok{:}
% \NormalTok{                hashedResult }\OperatorTok{=}\NormalTok{ Convert}\OperatorTok{.}\FunctionTok{ToHexString}\OperatorTok{(}\NormalTok{KeyDerivation}\OperatorTok{.}\FunctionTok{Pbkdf2}\OperatorTok{(}
% \NormalTok{                    password}\OperatorTok{:}\NormalTok{ password}\OperatorTok{,}
% \NormalTok{                    salt}\OperatorTok{:}\NormalTok{ salt}\OperatorTok{,}
% \NormalTok{                    prf}\OperatorTok{:}\NormalTok{ KeyDerivationPrf}\OperatorTok{.}\FunctionTok{HMACSHA256}\OperatorTok{,}
% \NormalTok{                    iterationCount}\OperatorTok{:} \DecValTok{600000}\OperatorTok{,}
% \NormalTok{                    numBytesRequested}\OperatorTok{:} \DecValTok{32}\OperatorTok{));}
% \NormalTok{                result }\OperatorTok{=}\NormalTok{ $}\StringTok{"\{Convert.ToHexString(salt)\}$\{hashedResult\}"}\OperatorTok{;}
%                 \KeywordTok{break}\OperatorTok{;}
%         \OperatorTok{\}}
...
% \begin{Shaded}
% \begin{Highlighting}[]
% \KeywordTok{public} \KeywordTok{static} \DataTypeTok{bool} \FunctionTok{CheckPasswordHash}\OperatorTok{(}\DataTypeTok{string}\NormalTok{ password}\OperatorTok{,} \DataTypeTok{string}\NormalTok{ hashedPassword}\OperatorTok{)}
%     \OperatorTok{\{}
%         \DataTypeTok{var}\NormalTok{ passwordParts }\OperatorTok{=}\NormalTok{ hashedPassword}\OperatorTok{.}\FunctionTok{Split}\OperatorTok{(}\CharTok{\textquotesingle{}$\textquotesingle{}}\OperatorTok{);}

%         \DataTypeTok{string}\NormalTok{ pp}\OperatorTok{;}

%         \KeywordTok{switch} \OperatorTok{(}\NormalTok{passwordParts}\OperatorTok{[}\DecValTok{0}\OperatorTok{])}
%         \OperatorTok{\{}
%             \KeywordTok{case} \StringTok{"SHA512"}\OperatorTok{:}
% \NormalTok{                pp }\OperatorTok{=} \FunctionTok{GeneratePasswordHash}\OperatorTok{(}\NormalTok{password}\OperatorTok{,}\NormalTok{ Convert}\OperatorTok{.}\FunctionTok{FromHexString}\OperatorTok{(}\NormalTok{passwordParts}\OperatorTok{[}\DecValTok{1}\OperatorTok{]),} \StringTok{"SHA512"}\OperatorTok{);}
%                 \KeywordTok{break}\OperatorTok{;}
%             \KeywordTok{default}\OperatorTok{:}
% \NormalTok{                pp }\OperatorTok{=} \FunctionTok{GeneratePasswordHash}\OperatorTok{(}\NormalTok{password}\OperatorTok{,}\NormalTok{ Convert}\OperatorTok{.}\FunctionTok{FromHexString}\OperatorTok{(}\NormalTok{passwordParts}\OperatorTok{[}\DecValTok{0}\OperatorTok{]),} \StringTok{"SHA256"}\OperatorTok{);}
%                 \KeywordTok{break}\OperatorTok{;}
%         \OperatorTok{\}}
%         \KeywordTok{return}\NormalTok{ pp }\OperatorTok{==}\NormalTok{ hashedPassword}\OperatorTok{;}
%     \OperatorTok{\}}
% \end{Highlighting}
% \end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textless{}}\NormalTok{PackageReference Include}\OperatorTok{=}\StringTok{"Community.Microsoft.Extensions.Caching.PostgreSql"}\NormalTok{ Version}\OperatorTok{=}\StringTok{"4.0.4"} \OperatorTok{/\textgreater{}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{builder}\OperatorTok{.}\FunctionTok{Services}\OperatorTok{.}\FunctionTok{AddDistributedPostgreSqlCache}\OperatorTok{(}\NormalTok{setup }\OperatorTok{=\textgreater{}}
\OperatorTok{\{}
\NormalTok{    setup}\OperatorTok{.}\FunctionTok{ConnectionString} \OperatorTok{=}\NormalTok{ builder}\OperatorTok{.}\FunctionTok{Configuration}\OperatorTok{.}\FunctionTok{GetConnectionString}\OperatorTok{(}\StringTok{"MinitwitDatabase"}\OperatorTok{);}
\NormalTok{    setup}\OperatorTok{.}\FunctionTok{SchemaName} \OperatorTok{=} \StringTok{"public"}\OperatorTok{;}
\NormalTok{    setup}\OperatorTok{.}\FunctionTok{TableName} \OperatorTok{=} \StringTok{"session"}\OperatorTok{;}
\NormalTok{    setup}\OperatorTok{.}\FunctionTok{DisableRemoveExpired} \OperatorTok{=} \KeywordTok{false}\OperatorTok{;}
\NormalTok{    setup}\OperatorTok{.}\FunctionTok{CreateInfrastructure} \OperatorTok{=} \KeywordTok{false}\OperatorTok{;}
\NormalTok{    setup}\OperatorTok{.}\FunctionTok{ExpiredItemsDeletionInterval} \OperatorTok{=}\NormalTok{ TimeSpan}\OperatorTok{.}\FunctionTok{FromMinutes}\OperatorTok{(}\DecValTok{15}\OperatorTok{);}
\OperatorTok{\});}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{create table }\KeywordTok{if}\NormalTok{ not exists }\StringTok{"session"}
\OperatorTok{(}
  \StringTok{"Id"}\NormalTok{ text COLLATE pg\_catalog}\OperatorTok{.}\StringTok{"default"}\NormalTok{ NOT NULL}\OperatorTok{,}
  \StringTok{"Value"}\NormalTok{ bytea}\OperatorTok{,}
  \StringTok{"ExpiresAtTime"}\NormalTok{ timestamp with time zone}\OperatorTok{,}
  \StringTok{"SlidingExpirationInSeconds"} \DataTypeTok{double}\NormalTok{ precision}\OperatorTok{,}
  \StringTok{"AbsoluteExpiration"}\NormalTok{ timestamp with time zone}\OperatorTok{,}
\NormalTok{  CONSTRAINT }\StringTok{"DistCache\_pkey"}\NormalTok{ PRIMARY }\FunctionTok{KEY} \OperatorTok{(}\StringTok{"Id"}\OperatorTok{)}
\OperatorTok{);}
\end{Highlighting}
\end{Shaded}
...
\AttributeTok{      }\KeywordTok{{-}}\AttributeTok{ Minitwit\_ConnectionStrings\_\_MinitwitDatabase=Host=minitwit{-}dev{-}database;Port=5432;Username=minitwit{-}sa;Password=123;Database=minitwit}
\AttributeTok{      }\KeywordTok{{-}}\AttributeTok{ Minitwit\_ConnectionStrings\_\_Redis=minitwit{-}cache:6379}

\AttributeTok{  }\FunctionTok{minitwit{-}db}\KeywordTok{:}
\AttributeTok{    }\FunctionTok{build}\KeywordTok{:}
\FunctionTok{@@ {-}27,3 +28,11 @@ services}\KeywordTok{:}
\AttributeTok{      }\KeywordTok{{-}}\AttributeTok{ main}
\AttributeTok{    }\FunctionTok{ports}\KeywordTok{:}
\AttributeTok{      }\KeywordTok{{-}}\AttributeTok{ }\StringTok{\textquotesingle{}5432:5432\textquotesingle{}}

\AttributeTok{  }\FunctionTok{cache}\KeywordTok{:}
\AttributeTok{    }\FunctionTok{image}\KeywordTok{:}\AttributeTok{ redis:7.2.4}
\AttributeTok{    }\FunctionTok{container\_name}\KeywordTok{:}\AttributeTok{ minitwit{-}cache}
\AttributeTok{    }\FunctionTok{networks}\KeywordTok{:}
\AttributeTok{      }\KeywordTok{{-}}\AttributeTok{ main}
\AttributeTok{    }\FunctionTok{ports}\KeywordTok{:}
\AttributeTok{      }\KeywordTok{{-}}\AttributeTok{ }\StringTok{\textquotesingle{}6379:6379\textquotesingle{}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{build{-}args}\KeywordTok{: }\CharTok{|}
\NormalTok{            DB\_CONN=$\{\{ secrets.DB\_CONNECTION \}\}}
\NormalTok{            REDIS\_CONN=$\{\{ secrets.REDIS\_CONNECTION \}\}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\AttributeTok{ }\KeywordTok{{-}}\AttributeTok{ }\FunctionTok{name}\KeywordTok{:}\AttributeTok{ Set up redis cache}
\AttributeTok{        }\FunctionTok{run}\KeywordTok{:}\AttributeTok{ docker compose {-}f docker{-}compose.yaml up cache {-}d}
\end{Highlighting}
\end{Shaded}
...
% \begin{Shaded}
% \begin{Highlighting}[]
% \AttributeTok{ENV Minitwit\_ConnectionStrings\_\_MinitwitDatabase=$\{REDIS\_CONN\}}
% \end{Highlighting}
% \end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{\textless{}}\NormalTok{PackageReference Include}\OperatorTok{=}\StringTok{"Microsoft.Extensions.Caching.StackExchangeRedis"}\NormalTok{ Version}\OperatorTok{=}\StringTok{"7.0.18"} \OperatorTok{/\textgreater{}}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
 \OperatorTok{\textless{}}\NormalTok{PackageReference Include}\OperatorTok{=}\StringTok{"StackExchange.Redis"}\NormalTok{ Version}\OperatorTok{=}\StringTok{"2.7.33"} \OperatorTok{/\textgreater{}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{builder}\OperatorTok{.}\FunctionTok{Services}\OperatorTok{.}\FunctionTok{AddStackExchangeRedisCache}\OperatorTok{(}\NormalTok{options }\OperatorTok{=\textgreater{}}
\OperatorTok{\{}
\NormalTok{     options}\OperatorTok{.}\FunctionTok{Configuration} \OperatorTok{=}\NormalTok{ builder}\OperatorTok{.}\FunctionTok{Configuration}\OperatorTok{.}\FunctionTok{GetConnectionString}\OperatorTok{(}\StringTok{"Redis"}\OperatorTok{);}
\NormalTok{   options}\OperatorTok{.}\FunctionTok{InstanceName} \OperatorTok{=} \StringTok{"minitwit\_"}\OperatorTok{;}
\OperatorTok{\});}
...
\begin{Shaded}
\begin{Highlighting}[]
\ErrorTok{"ConnectionStrings":} \FunctionTok{\{}
    \DataTypeTok{"MinitwitDatabase"}\FunctionTok{:} \StringTok{"Host=127.0.0.1;Port=5432;Username=minitwit{-}sa;Password=123;Database=minitwit"}
    \StringTok{"MinitwitDatabase"}\ErrorTok{:} \StringTok{"Host=127.0.0.1;Port=5432;Username=minitwit{-}sa;Password=123;Database=minitwit"}\FunctionTok{,}
    \DataTypeTok{"Redis"}\FunctionTok{:} \StringTok{"localhost:6379"}
  \FunctionTok{\}}
\end{Highlighting}
\end{Shaded}
...
\item Close ports:
    ...
    \begin{itemize}
        ...
        \begin{figure}
        \centering
        \includegraphics{Log 8f540289b13a4fffb76a9996bb03c9a8/Untitled 2.png}
        \caption{Untitled}
        \end{figure}
